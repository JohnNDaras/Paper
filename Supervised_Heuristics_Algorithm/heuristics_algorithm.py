...
class Heuristics_Algorithm:
    ...
    def __init__(self, budget: int, qPairs: int, delimiter: str, sourceFilePath: str, targetFilePath: str, HeuristicCondition: str, ConditionLimit, DynamicFactor, ViolationLimit):
