...
class Extrapolation:
    ...
    def getMethodName(self):
        return 'Extrapolation Algorithm with Unsupervised Scheduling'
        ...
        for targetGeom in targetData:
            ...
            for candidateMatchId in candidates:
                if self.validCandidate(candidateMatchId, targetGeom.envelope):
                    ...
                    self.manageSample(candidateMatchId, targetId, targetGeom)
    ...
    def manageSample(self, candidateMatchId, targetId, targetGeom):
        if len(self.sample) < SAMPLE_SIZE:
            if random.randint(0, RANDOM_THRESHOLD) == 0:
    ...
    def verification(self):
        ...
        for weight, (candidateMatchId, targetId, targetGeom) in reversed(self.sorted_list):
            if truePositiveDecisions < math.floor(maxsize):
                ...
                break
        print("True Positive Decisions\t:\t", truePositiveDecisions)
